...
<CardGroup cols={2}>
  ...
  <Card title="API Implementation (Recommended)" icon="webhook" href="https://learn-more-link.com">
  ...
  <Card title="JavaScript Implementation" icon="js" href="https://learn-more-link.com">
   This method allows embedding the tracker as a custom Javascript file, anywhere within the HTML pages in your site.
  </Card>
  <Card title="Tag Manager Implementation" icon="tag" href="https://learn-more-link.com">
  ...
  <Card title="Native app SDKs" icon="paperclip" href="https://learn-more-link.com">
    With just a few lines of code, you can embed our SDKs into your app and start capturing data in real-time.
  </Card>
</CardGroup>