...
In addition to the attributes mentioned above, some miscellaneous data needs to be included as well. These should be added under the object named `misc`. Please refer to the table below for the specific attributes to be added under misc.
