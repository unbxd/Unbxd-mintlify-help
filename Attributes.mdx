...
Default attributes are ==predefined== segmentation criteria available in the Unbxd platform. These attributes help categorize shoppers based on common factors without additional configuration.

Example:
Location – A shopper from New York sees winter clothing recommendations, while a shopper from California sees summer apparel.
