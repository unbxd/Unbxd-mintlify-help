...
- **Autosuggest**: Only fields marked as [Augtosuggest ](https://docs.netcoreunbxd.com/user-guides/merchandising/autosuggest)will appear in keyword suggestions, infield suggestions, and search fields under the popular products section.
