...
2. **Visual Search** must be enabled on your UNBXD panel. Only admin account can enable this feature.

   <Info>
     Merchandisers do not have access to admin privileges, contact **Unbxd Support Team** to enable this feature for your panel.
   </Info>
