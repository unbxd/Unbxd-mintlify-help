...
2. **Visual Search** must be enabled on your UNBXD panel. 
   ...
   <Info>
     Note:
     1. Visual Search is a **paid** feature and is not included by default in the standard Unbxd Panel.


     1. Merchandisers do not have access to enable this feature, contact **Unbxd Business Team** to enable this feature for your panel.
   </Info>
