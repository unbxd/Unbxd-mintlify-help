...
Shopping Assistant is an AI-driven chatbot integrated into e-commerce websites. It assists customers by understanding their preferences, guiding them in product selection, and offering tailored suggestions based on their interactions with the site.
...
| **products**   | array    | A list of recommended products, each containing:  productId (string): Unique identifier of the product.  - title (string): Title of the product. - imageUrl (string): URL of the product image. - productUrl (string): URL of the product details page. - price (number): Price of the product. - (... and potentially other product-specific fields custom configured for the site). | Yes          |
| **productId**  | string   | Unique identifier of the product.                                                                                                                                                                                                                                                                                                                                                     | Yes          |
| **title**      | string   | Title of the product.                                                                                                                                                                                                                                                                                                                                                                 | Yes          |
| **imageUrl**   | string   | URL of the product image.                                                                                                                                                                                                                                                                                                                                                             | Yes          |
| **productUrl** | string   | URL of the product details page.                                                                                                                                                                                                                                                                                                                                                      | Yes          |
| **price**      | number   | Price of the product.                                                                                                                                                                                                                                                                                                                                                                 | Yes          |
| **filters**    | array    | An array of additional filters that the user can apply to further refine the results.                                                                                                                                                                                                                                                                                                 | No           |
