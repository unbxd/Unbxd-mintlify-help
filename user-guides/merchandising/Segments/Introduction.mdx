...
3. Set up the attributes in the next block. You can set up a maximum of 6 attributes, which includes one default attribute and five custom attribute.\
   \
...
4. 
5. Select the conditions of \<\<glossary:segmentation\>\> as required. Select **AND** or **OR** based on your requirement.
6. To add a block, click **ADD BLOCK**.
7. Click on the dropdown to select an **attribute** or **event**.