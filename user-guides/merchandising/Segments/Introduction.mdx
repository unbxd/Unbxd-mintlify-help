...
<Info>1. In addition to the default attributes, you can add up to **five custom** attributes</Info>
<Info>2.All of them can be rearranged in order of importance by drag and drop operations on the
console. Learn more about Default attributes and Custom attribute (link Attributes MDX file here)</Info>
