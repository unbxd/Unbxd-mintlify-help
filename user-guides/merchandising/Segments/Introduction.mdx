...
2. Provide the name of your segment at the **Add Segment Name** box on top.

3. Set up the attributes in the next block. You can set up a maximum of 6 attributes, which includes 1      default attribute and 5 custom attribute\
\
