...
<Info>
  To enable Index Time Synonyms for your panel, contact **Unbxd Support Team**..
</Info>

### **How it works**

This feature is accessible only to Unbxd Admin users. Log in to Netcore Unbxd Dashboard and navigate to **Algorithm** \> **Content** \> **Index Time Synonym**.
