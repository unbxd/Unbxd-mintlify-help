---
title: "Promotions"
description: "Highlight your products by prioritizing, pinning, arranging, and organizing to present what shoppers desire to view."
---
...
- **Query is**: Define the search query (e.g: winter boots) that will trigger the redirect.
...
You can turn on A/B testing to compare two different merchandising strategies or test your strategy against Netcore Unbxd’s default results.

Here is how to set it up:

- **Traffic Split**: Decide how to divide your website traffic between the two versions (e.g., 50-50, 60-40, or 70-30). Just make sure the total equals 100%.
- **Pick a Winning Metric**: Select how to measure success using the “Winner is decided by” dropdown. The options include:
  - Click Rate
  - Average Order Value
  - Revenue Per Visit
  - Conversion Rate
  - Cart Rate
- **Set Test Duration**: Select how long the test should run. This time should be **shorter than your full campaign**.
- **Choose a Backup Plan**: If no clear winner is found, pick a **Preferred variation** as your fallback option so the campaign keeps running smoothly.

Once you are done, click **Apply**. You can now continue setting up your merchandising strategy.

<Info>
  - If you are comparing **Variation A vs. Variation B**, you need to configure both.
  - If you are testing **Variation A vs. the default Unbxd results**, you only need to set up Variation A.
</Info>
