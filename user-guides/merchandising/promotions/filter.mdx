...
1. Use *+ Add new Filter group* to create additional Filter groups.
...
<Note>Viewing the summary before applying the changes will lead to the configurations being lost. It is *recommended* that you click Apply filter before viewing the summary.</Note>
