...
We are excited to announce **AI-Suggested Similar Queries**, which will help improve the shopper experience by surfacing relevant, intent-driven search suggestions.\
**What it does:**
...
We have enhanced the **Manage** section by adding support for bulk upload of searchable fields. This makes it faster to update multiple entries at once.