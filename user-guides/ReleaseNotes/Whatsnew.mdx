...
We’re pleased to announce that the ****Unbxd Search and Browse Console is now fully compliant with theOWASP (Open Web Application Security Project) Top 10 standards**** .
...
**Example:**\
 If a user searches for **White Dresses**, the system might suggest related queries like **white dress**, **white shoes**, **white bag**, or **white sneakers**.For more information, refer to the [documentation](https://docs.netcoreunbxd.com/user-guides/merchandising/promotions/promotions-ai-suggested-queries).
