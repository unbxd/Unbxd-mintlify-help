...
<CardGroup cols="2">
  <Card title="What can Netcore Unbxd do?" icon="square-1" color="#NaNNaNNaN" horizontal href="https://docs.netcoreunbxd.com/GettingStarted/Introduction#discover-what%E2%80%99s-possible-with-netcore-unbxd">
    
  </Card>
  <Card title="What are the Core Offering?" icon="square-2" color="#NaNNaNNaN" horizontal cta="https://docs.netcoreunbxd.com/GettingStarted/Introduction#core-features-that-drive-results">
    
  </Card>
</CardGroup>

<CardGroup cols="2">
  <Card title="Why use Netcore Unbxd?" icon="square-3" color="#NaNNaNNaN" horizontal href="https://docs.netcoreunbxd.com/GettingStarted/Introduction#why-netcore-unbxd-is-the-right-choice%3F">
    
  </Card>
  <Card title="How can Netcore Unbxd help you?" icon="square-4" color="#NaNNaNNaN" horizontal cta="https://docs.netcoreunbxd.com/GettingStarted/Introduction#how-can-unbxd-make-a-difference-for-you%3F">
