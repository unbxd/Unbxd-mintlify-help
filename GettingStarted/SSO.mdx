...
description: "Learn how to set up Single Sign On (SSO) in Netcore Unbxd for secure app-based login."
---
...
> **Note**: The user must be registered for the Azure App. This registration is done by the Netcore Unbxd support team.
